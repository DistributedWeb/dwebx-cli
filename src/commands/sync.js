module.exports = {
  ...
  command: sync,
  help: [
    'Sync a DWebX archive with the network',
  ...
  options: [
    {
      ...
      boolean: true,
      default: true,
      help: 'Import files from the directory to the database (DWebX Writable).'
    },
    {
      name: 'ignoreHidden',
      boolean: true,
    ...
    },
    {
      ...
      boolean: true,
      default: true,
      help: 'Watch for changes and import updated files (DWebX Writable).'
    },
    {
      name: 'show-key',
      boolean: true,
      default: false,
      abbr: 'k',
      help: 'Print out the dwebx key (DWebX Not Writable).'
    }
  ]
}
